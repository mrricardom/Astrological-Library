...
const starQuotes = {
  124: 'As an Aries, you are represented by the ram. You love to be number 1. As a passionate person, you are known for your bold and ambitious nature. Your legendary short temper is a result of your hatred towards exhaustive details and unnecessary nuisances. Be careful of your think after you leap mentality as that could land you in hot water.  Like Miss Vanjie, you too are known to be carefree and someone who lives life to their fullest when not in rage mode. Get these cookies!',
  109: 'As a Taurus, you are represented by the bull. Your hedonistic ways mean you are not one to skimp on comfort and luxury. Your taste for the finer things doesn’t mean that you aren’t willing to put in the work to get said things. Like Peppermint, you too have put in so much work to get where you are in life just to reach some stability. You are also known for your stubborn antics. Be careful not to let your bullheaded determination make you linger in unhealthy and unnecessary situations just to prove a point. No one is going to take this result from you cold, dead, manicured hands.',
  ...
  31: 'As a Virgo, you are represented by the goddess of wheat and agriculture.  You are known for your logical, practical, and systematic approach in life. You are a perfectionist at heart. Much like Manila Luzon, you too are known for your well put together image that has had every detail planned out. Be careful in letting that meticulousness getting in the way of yourself and how you perceive others. Don’t be a Sprepper!',
